...
<head>
    ...
    <title>Daftar - Sistem Informasi Desa Timbala</title>
    <!-- CSS files -->
                    ...
                    <div class="card-body">
                        <div class="text-center mb-0 mt-3">
                            <div class="navbar-brand text-dark">
                                <img src="{{ asset('images/logo 1.png') }}" alt="Logo Desa Timbala" style="height: 50px; margin-bottom: 10px;">
                                <h1 class="m-0">Desa Timbala</h1>
                                <p class="text-muted mt-1">Sistem Informasi Desa</p>
                            </div>
                        </div>
                        <div class="px-2">
                            <div class="card-body">
